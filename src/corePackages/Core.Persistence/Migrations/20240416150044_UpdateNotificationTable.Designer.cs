...
namespace Core.Persistence.Migrations
{
    ...
    [Migration("20240416150044_UpdateNotificationTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Domain.Entities.ArticleReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Core.Domain.Entities.ArticleVote", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Core.Domain.Entities.FavoriteArticle", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Core.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsDeleted = false,
                            LastName = "Admin",
                            PasswordHash = new byte[] { 139, 191, 177, 28, 57, 211, 143, 129, 197, 145, 121, 212, 8, 78, 25, 194, 230, 106, 251, 142, 135, 245, 52, 110, 202, 68, 189, 48, 43, 156, 103, 81, 104, 45, 206, 227, 251, 128, 34, 250, 23, 72, 99, 31, 135, 120, 186, 233, 173, 87, 15, 161, 249, 190, 144, 170, 40, 213, 180, 73, 247, 183, 249, 237 },
                            PasswordSalt = new byte[] { 69, 249, 87, 109, 189, 251, 85, 103, 215, 243, 170, 96, 246, 4, 148, 126, 110, 11, 130, 93, 6, 30, 193, 28, 182, 109, 179, 227, 78, 247, 89, 73, 130, 180, 179, 33, 17, 197, 41, 38, 112, 46, 203, 245, 189, 52, 230, 68, 39, 164, 24, 96, 99, 40, 93, 74, 76, 255, 13, 44, 254, 194, 178, 35, 124, 249, 1, 173, 101, 96, 143, 23, 82, 252, 182, 67, 61, 9, 36, 227, 5, 183, 196, 177, 52, 1, 123, 155, 254, 123, 44, 105, 210, 170, 24, 195, 131, 255, 87, 134, 99, 127, 168, 36, 32, 109, 160, 240, 240, 251, 129, 195, 66, 215, 8, 104, 32, 163, 240, 167, 247, 48, 214, 202, 133, 216, 11, 54 },
                            Status = 1
                        });
                });
            ...
            modelBuilder.Entity("Core.Domain.Entities.UserUploadedFile", b =>
                {
                    ...
                    b.ToTable("UserUploadedFiles", (string)null);
                });
            ...
            modelBuilder.Entity("Core.Domain.Entities.UploadedFile", b =>
                {
                    ...
                    b.Navigation("UserUploadedFiles");
                });
