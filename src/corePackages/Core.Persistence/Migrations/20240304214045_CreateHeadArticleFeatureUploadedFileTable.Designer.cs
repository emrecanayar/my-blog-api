...
namespace Core.Persistence.Migrations
{
    ...
    [Migration("20240304214045_CreateHeadArticleFeatureUploadedFileTable")]
    partial class CreateHeadArticleFeatureUploadedFileTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Core.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsDeleted = false,
                            LastName = "Admin",
                            PasswordHash = new byte[] { 114, 94, 111, 21, 230, 252, 220, 58, 175, 244, 130, 162, 230, 116, 16, 174, 238, 12, 44, 231, 222, 95, 141, 156, 199, 174, 51, 104, 205, 115, 100, 84, 150, 51, 232, 240, 206, 125, 234, 65, 29, 0, 240, 121, 181, 114, 57, 189, 159, 61, 42, 241, 69, 174, 162, 3, 110, 194, 111, 253, 3, 101, 129, 28 },
                            PasswordSalt = new byte[] { 21, 89, 131, 24, 99, 176, 140, 163, 50, 190, 69, 77, 156, 90, 172, 229, 96, 49, 204, 82, 210, 114, 240, 9, 50, 79, 178, 105, 231, 219, 57, 80, 107, 35, 72, 158, 138, 66, 227, 121, 195, 72, 241, 40, 70, 27, 186, 58, 54, 64, 183, 116, 157, 139, 118, 141, 238, 131, 120, 116, 36, 79, 51, 139, 145, 195, 244, 229, 207, 67, 59, 201, 125, 18, 121, 77, 234, 109, 10, 167, 130, 173, 87, 118, 5, 19, 4, 217, 92, 97, 38, 225, 100, 42, 134, 250, 156, 203, 106, 15, 249, 129, 48, 133, 239, 69, 58, 249, 209, 191, 230, 104, 190, 116, 164, 3, 66, 89, 170, 58, 57, 48, 249, 246, 231, 127, 95, 102 },
                            Status = 1
                        });
                });
