...
namespace Core.Persistence.Migrations
{
    ...
    [Migration("20240313112445_CreateNotificationTable")]
            ...
            modelBuilder.Entity("Core.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsDeleted = false,
                            LastName = "Admin",
                            PasswordHash = new byte[] { 60, 59, 17, 68, 235, 166, 173, 97, 126, 116, 148, 120, 228, 145, 247, 220, 229, 198, 112, 59, 78, 26, 157, 145, 238, 86, 15, 90, 10, 209, 212, 174, 10, 102, 192, 95, 251, 67, 121, 124, 197, 197, 28, 98, 102, 40, 223, 223, 86, 34, 81, 217, 113, 107, 74, 84, 209, 13, 224, 228, 90, 185, 68, 142 },
                            PasswordSalt = new byte[] { 152, 235, 104, 55, 87, 66, 154, 235, 5, 189, 116, 61, 101, 35, 165, 219, 165, 50, 148, 94, 221, 160, 232, 142, 109, 77, 38, 219, 50, 236, 137, 84, 132, 119, 150, 62, 96, 207, 193, 13, 116, 182, 142, 96, 213, 229, 110, 77, 209, 229, 20, 254, 85, 184, 79, 204, 104, 51, 236, 209, 45, 158, 124, 254, 30, 69, 36, 214, 218, 0, 155, 153, 147, 165, 22, 210, 40, 228, 51, 251, 207, 199, 198, 110, 81, 175, 79, 17, 8, 146, 53, 11, 12, 95, 201, 75, 186, 210, 39, 123, 10, 36, 36, 143, 131, 97, 12, 37, 211, 3, 245, 160, 159, 113, 117, 252, 253, 228, 241, 128, 202, 172, 143, 146, 153, 173, 70, 79 },
                            Status = 1
                        });
                });
