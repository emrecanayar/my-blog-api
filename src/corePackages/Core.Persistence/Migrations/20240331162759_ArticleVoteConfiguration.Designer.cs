...
namespace Core.Persistence.Migrations
{
    ...
    [Migration("20240331162759_ArticleVoteConfiguration")]
    partial class ArticleVoteConfiguration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Core.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsDeleted = false,
                            LastName = "Admin",
                            PasswordHash = new byte[] { 53, 64, 195, 30, 182, 101, 115, 18, 109, 72, 224, 249, 211, 188, 132, 49, 124, 214, 199, 33, 79, 75, 220, 63, 44, 80, 17, 132, 183, 182, 164, 200, 212, 248, 1, 23, 243, 226, 5, 247, 235, 167, 236, 185, 239, 228, 195, 28, 100, 98, 236, 90, 152, 126, 131, 167, 190, 165, 95, 117, 159, 130, 127, 14 },
                            PasswordSalt = new byte[] { 186, 215, 103, 104, 6, 213, 183, 15, 70, 249, 113, 108, 86, 231, 247, 224, 70, 34, 124, 179, 116, 205, 223, 66, 145, 81, 58, 54, 111, 252, 156, 39, 186, 5, 137, 120, 43, 12, 200, 113, 159, 214, 187, 32, 13, 212, 156, 192, 134, 100, 63, 98, 139, 243, 65, 247, 74, 233, 84, 208, 15, 59, 204, 76, 23, 195, 187, 81, 100, 249, 18, 120, 64, 206, 203, 63, 76, 1, 23, 78, 41, 38, 113, 39, 150, 77, 18, 188, 159, 99, 42, 35, 252, 211, 75, 124, 119, 94, 233, 123, 28, 151, 28, 12, 196, 10, 115, 214, 167, 100, 138, 52, 198, 135, 81, 206, 191, 8, 113, 105, 167, 90, 133, 98, 66, 71, 84, 195 },
                            Status = 1
                        });
                });
