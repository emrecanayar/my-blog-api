...
namespace Core.Persistence.Migrations
{
    ...
    [Migration("20240301130330_CreateFeatureTable")]
            ...
            modelBuilder.Entity("Core.Domain.Entities.OperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("dbcf0471-5852-47bd-b3ef-65ca7d440257"),
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2024, 3, 1, 16, 3, 25, 747, DateTimeKind.Local).AddTicks(6932),
                            IsDeleted = false,
                            Name = "Admin",
                            Status = 1
                        });
            ...
            modelBuilder.Entity("Core.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9ed31b90-87a7-43b1-bc71-bb83a905fbf9"),
                            AuthenticatorType = 0,
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2024, 3, 1, 16, 3, 25, 749, DateTimeKind.Local).AddTicks(5843),
                            CultureType = 0,
                            Email = "admin@admin.com",
                            FirstName = "Admin",
                            IsDeleted = false,
                            LastName = "Admin",
                            PasswordHash = new byte[] { 177, 199, 239, 65, 223, 188, 148, 143, 2, 77, 46, 213, 41, 234, 37, 253, 130, 57, 27, 195, 134, 175, 125, 139, 252, 78, 84, 175, 85, 72, 38, 22, 68, 174, 50, 64, 50, 154, 245, 128, 191, 101, 190, 194, 214, 27, 207, 63, 151, 16, 177, 34, 160, 26, 209, 253, 32, 192, 13, 145, 187, 188, 207, 30 },
                            PasswordSalt = new byte[] { 74, 93, 194, 98, 95, 61, 96, 22, 231, 3, 73, 234, 173, 76, 37, 224, 112, 177, 155, 6, 201, 85, 178, 121, 252, 253, 28, 55, 220, 194, 51, 84, 36, 98, 32, 73, 31, 26, 252, 93, 178, 194, 163, 43, 89, 228, 222, 45, 187, 36, 10, 163, 40, 46, 114, 77, 165, 48, 241, 56, 137, 17, 151, 153, 220, 99, 125, 107, 101, 40, 1, 36, 132, 109, 165, 185, 44, 6, 15, 161, 125, 100, 79, 57, 246, 68, 254, 132, 69, 203, 12, 250, 244, 220, 11, 157, 19, 195, 109, 98, 198, 211, 38, 197, 231, 64, 102, 72, 87, 194, 74, 77, 38, 61, 131, 12, 72, 242, 61, 169, 39, 240, 78, 56, 17, 184, 35, 109 },
                            Status = 1
                        });
                });
            ...
            modelBuilder.Entity("Core.Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1c5decf2-cf7d-4553-838b-53fa5eee4573"),
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2024, 3, 1, 16, 3, 25, 750, DateTimeKind.Local).AddTicks(3782),
                            IsDeleted = false,
                            OperationClaimId = new Guid("dbcf0471-5852-47bd-b3ef-65ca7d440257"),
                            Status = 1,
                            UserId = new Guid("9ed31b90-87a7-43b1-bc71-bb83a905fbf9")
                        });
                });
