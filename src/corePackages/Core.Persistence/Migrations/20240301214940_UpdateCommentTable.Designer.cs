...
namespace Core.Persistence.Migrations
{
    ...
    [Migration("20240301214940_UpdateCommentTable")]
            ...
            modelBuilder.Entity("Core.Domain.Entities.OperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2024, 3, 2, 0, 49, 37, 69, DateTimeKind.Local).AddTicks(3384),
                            IsDeleted = false,
                            Name = "Admin",
                            Status = 1
                        });
            ...
            modelBuilder.Entity("Core.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AuthenticatorType = 0,
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2024, 3, 2, 0, 49, 37, 71, DateTimeKind.Local).AddTicks(7877),
                            CultureType = 0,
                            Email = "admin@admin.com",
                            FirstName = "Admin",
                            IsDeleted = false,
                            LastName = "Admin",
                            PasswordHash = new byte[] { 184, 116, 171, 120, 80, 148, 250, 134, 15, 66, 157, 122, 77, 174, 89, 25, 75, 94, 10, 11, 94, 25, 107, 138, 182, 214, 34, 191, 100, 159, 108, 198, 51, 76, 28, 122, 30, 210, 125, 76, 73, 143, 199, 227, 65, 160, 57, 211, 163, 178, 248, 86, 56, 251, 7, 232, 2, 91, 181, 215, 74, 156, 142, 199 },
                            PasswordSalt = new byte[] { 70, 27, 212, 199, 220, 9, 61, 109, 208, 50, 77, 84, 247, 202, 166, 68, 179, 61, 188, 214, 6, 205, 73, 65, 112, 95, 236, 56, 206, 29, 247, 123, 193, 9, 253, 184, 178, 191, 144, 153, 174, 107, 240, 99, 244, 191, 246, 69, 165, 80, 141, 218, 28, 246, 182, 12, 234, 144, 33, 120, 124, 219, 244, 57, 113, 46, 69, 182, 172, 187, 27, 160, 240, 189, 151, 203, 232, 192, 125, 237, 16, 123, 67, 64, 108, 102, 138, 60, 99, 24, 141, 185, 237, 59, 242, 89, 22, 28, 206, 136, 7, 109, 242, 56, 22, 241, 63, 239, 251, 159, 79, 227, 18, 108, 236, 242, 121, 2, 239, 55, 73, 61, 223, 175, 76, 147, 240, 250 },
                            Status = 1
                        });
                });
            ...
            modelBuilder.Entity("Core.Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2024, 3, 2, 0, 49, 37, 72, DateTimeKind.Local).AddTicks(5556),
                            IsDeleted = false,
