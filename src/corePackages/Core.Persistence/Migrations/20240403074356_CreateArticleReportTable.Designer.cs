...
namespace Core.Persistence.Migrations
{
    ...
    [Migration("20240403074356_CreateArticleReportTable")]
    partial class CreateArticleReportTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Core.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsDeleted = false,
                            LastName = "Admin",
                            PasswordHash = new byte[] { 143, 186, 58, 1, 174, 44, 70, 188, 134, 196, 61, 214, 56, 153, 33, 214, 108, 112, 90, 146, 81, 243, 1, 193, 131, 108, 64, 69, 192, 137, 12, 130, 33, 188, 87, 234, 247, 223, 189, 66, 204, 240, 118, 145, 108, 25, 222, 13, 95, 68, 170, 158, 94, 130, 205, 176, 114, 231, 116, 255, 199, 8, 37, 196 },
                            PasswordSalt = new byte[] { 203, 120, 89, 162, 13, 111, 106, 148, 168, 155, 56, 7, 247, 211, 43, 77, 213, 147, 59, 175, 205, 104, 168, 192, 32, 32, 35, 22, 64, 61, 135, 203, 50, 107, 66, 27, 163, 143, 153, 91, 11, 149, 113, 93, 90, 8, 131, 0, 65, 220, 224, 0, 47, 43, 92, 175, 157, 236, 96, 70, 133, 37, 16, 42, 66, 220, 163, 147, 240, 186, 8, 86, 183, 175, 147, 253, 235, 135, 173, 146, 233, 117, 226, 95, 28, 1, 106, 112, 112, 35, 75, 102, 64, 233, 151, 176, 202, 146, 175, 236, 191, 179, 223, 66, 176, 124, 172, 135, 134, 95, 32, 72, 64, 234, 193, 209, 209, 17, 79, 231, 68, 124, 159, 20, 117, 158, 173, 142 },
                            Status = 1
                        });
                });
