...
namespace Core.Persistence.Migrations
{
    ...
    [Migration("20240318145337_CreateLikeTable")]
            ...
            modelBuilder.Entity("Core.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsDeleted = false,
                            LastName = "Admin",
                            PasswordHash = new byte[] { 154, 143, 243, 144, 82, 153, 203, 137, 26, 176, 138, 99, 241, 9, 200, 153, 122, 28, 49, 163, 176, 152, 105, 138, 37, 235, 218, 213, 42, 116, 204, 149, 207, 172, 106, 119, 152, 104, 50, 157, 115, 130, 244, 169, 9, 61, 5, 125, 49, 56, 195, 41, 213, 45, 22, 117, 35, 193, 102, 59, 192, 183, 171, 140 },
                            PasswordSalt = new byte[] { 131, 155, 255, 14, 85, 181, 31, 10, 11, 244, 246, 244, 159, 20, 135, 20, 104, 76, 234, 4, 83, 234, 131, 80, 101, 121, 211, 25, 178, 206, 43, 161, 55, 43, 252, 67, 240, 56, 54, 100, 149, 223, 149, 73, 151, 126, 200, 9, 79, 169, 18, 153, 102, 117, 225, 200, 3, 101, 214, 67, 55, 4, 17, 21, 105, 86, 89, 141, 250, 37, 231, 154, 145, 206, 135, 146, 133, 100, 190, 226, 207, 131, 79, 64, 1, 52, 140, 94, 196, 133, 245, 228, 66, 186, 101, 241, 254, 77, 141, 82, 65, 70, 253, 54, 38, 201, 189, 194, 135, 119, 62, 175, 117, 169, 185, 176, 126, 176, 142, 134, 153, 150, 38, 135, 137, 64, 228, 175 },
                            Status = 1
                        });
                });
