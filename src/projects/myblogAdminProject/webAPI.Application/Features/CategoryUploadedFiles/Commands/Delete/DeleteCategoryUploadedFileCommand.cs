...
public class DeleteCategoryUploadedFileCommand : IRequest<CustomResponseDto<DeletedCategoryUploadedFileResponse>>, ISecuredRequest
{
    public Guid Id { get; set; }

    public string[] Roles => new[] { Admin, Write, CategoryUploadedFilesOperationClaims.Delete };
